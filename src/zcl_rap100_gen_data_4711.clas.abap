CLASS zcl_rap100_gen_data_4711 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_4711 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    "clear data
    DELETE FROM zrap100_atrav471.

    "insert travel demo data
    INSERT zrap100_atrav471 FROM (
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_ATRAV471 | ).
